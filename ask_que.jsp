<%-- 
    Document   : ask_que
    Created on : 26 Apr, 2022, 3:28:40 PM
    Author     : hp
--%>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="container-fluid" id="data">
                <div class="row">
                    <div class="col-sm-5" style="padding:20px;"><center style="padding-top: 50px"><h3>Ask a public question</h3></center></div>
                    <div class="col-sm-6"><img src="ask.png" class="img-fluid"></div>
                </div>
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <%
                            if(request.getParameter("success")!=null){
                              out.println("<h6 class='alert alert-success'>Question Inserted Succesfully !</h6>");
                            }
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="ask_que_insert.jsp" method="post">
                                    <h5 style="color: black;">Title</h5>
                                    <label >Be specific and imagine you’re asking a question to another person</label>
                                    <input type="text" class="form-control" name="title" placeholder="e.g. what is the operator overloading ?"><br>
                                    <h5 style="color: black;">Detail</h5>
                                    <label>Include all the information someone would need to answer your question</label>
                                    <textarea type="text" class="form-control" name="detail" rows="6" placeholder="detail..."></textarea><br>
                                    <h5 style="color: black;">Tags</h5>
                                    <label >Add tags to describe what your question is about </label>
                                    ...
                                    %>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="checkbox" name="checkbox" class="form-check-input" value="<%=rs1.getString("category_name")%>">
