<%-- 
    Document   : change_user_img_upload
    Created on : 2 May, 2022, 7:22:29 AM
    Author     : hp
--%>
    ...
    try{
        ...
        if(email==null && session.getAttribute(email)==null){
            ...
            if(request.getParameter("code")==null){
                response.sendRedirect("profile.jsp?upload_code_error=1");
            }
            else{
                ...
                try
                {
                    ...
                    response.sendRedirect("profile.jsp?img_error=1");
                }
                }
                //response.sendRedirect("index.jsp");
            }
