      ...
      <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="container-fluid" id="data">
                <div class="row">
                    <div class="col-sm-10">
                        <h3 style="color:black">Top Questions</h3>
                    </div>
                    <div class="col-sm-2">
                    ...
                    <div class="col-sm-2">
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-secondary active">
                                <input type="radio" name="options" onclick="event()" class="newest" id="option1" autocomplete="off" checked> Newest
                            </label>
                            <label class="btn btn-secondary">
                              <input type="radio" name="options" class="oldest" id="option3" autocomplete="off"> Oldest
                            </label>
                        </div>
                    </div>
                    <script>
                       $(document).ready(function(){
                           $(".btn.btn-secondary").click(function(){
                               var sort = $(this).text();
                               $.post(
                                     "que_sort.jsp",{sort:sort},function(data){
                                         $("#sort").html(data);
                                     }
                               );
                           });
